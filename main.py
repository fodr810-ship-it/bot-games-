...
intents.guilds = True
intents.members = True        # 👈 تفعيل صلاحية الأعضاء (مهمة جداً للترحيب الصوتي)
intents.voice_states = True   # 👈 تفعيل صلاحية الرومات الصوتية (السماح بدخول الصوت وقراءة الأحداث)
